				...
				<div class="container">
					...
					<div class="row nav-menu">
						...
						<div class="col-sm-12 columns text-center">
							<ul class="menu">
								<a></a><li><a href="{{ url('/') }}" >Ponuda Mjeseca</a></li><li><a href="{{ route('katalog') }}">Katalog</a></li><li><a href="{{ url('/onama') }}">O nama</a></li><li><a href="{{ url('/kontakt') }}">Kontakt</a></li>
			...
			<section class="contact-center">
				<div class="container">
					...
					<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
							<h1>Neka pitanja? <br>Mozda zelite da probate vina?<br></h1>
							<p class="lead">contact@winery.com
		<br>+80 984 349 492<br>
		<br>Najbolja Vinarija<br>200 Provence-Alpes,&nbsp;France</p>
